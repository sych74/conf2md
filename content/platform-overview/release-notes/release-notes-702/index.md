...
aliases: "/release-notes-702/"
seoindex: "index, follow"
seotitle: "Release Notes 7.0.2"
seokeywords: "paas, paas release notes, paas version, 7.0.2 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 7.0.2 release."
menu: 
    docs:
        title: "Release Notes 7.0.2"
        url: "/release-notes-702/"
        weight: 42
        parent: "release-notes"
        identifier: "release-notes-702.md"
---

<a id="back"></a>

# Virtuozzo Application Platform 7.0.2

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 7.0.2** release.
...
Below, you can find the fixes that were implemented in the PaaS 7.0.2 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 7.0.2"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
K8S-245|-|Incorrect account quotas are checked when installing the *Kubernetes Cluster* package as a collaborator
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 7.0.2 release:

{{%table3 title="PaaS 7.0.2"%}}
**#**|**Affected Versions**|**Description**
---|:---:|---
JE-43598|5.5.2|An unhandled error occurs when deploying an archive to the unsupported node type
JE-58087|-|An error occurs during the custom containers "*aftercreate*" configuration
JE-61583|-|Unstable connection when accessing to nodes via the *Web SSH* client
JE-61699|6.3.2|An error occurs when managing variables or redeploying containers if one of the environment variables is empty
{{%/table3%}}
