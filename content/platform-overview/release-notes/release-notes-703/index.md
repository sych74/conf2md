...
aliases: "/release-notes-703/"
seoindex: "index, follow"
seotitle: "Release Notes 7.0.3"
seokeywords: "paas, paas release notes, paas version, 7.0.3 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 7.0.3 release."
menu: 
    docs:
        title: "Release Notes 7.0.3"
        url: "/release-notes-703/"
        weight: 41
        parent: "release-notes"
        identifier: "release-notes-703.md"
---

<a id="back"></a>

# Virtuozzo Application Platform 7.0.3

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 7.0.3** release.
...
Below, you can find the fixes that were implemented in the PaaS 7.0.3 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 7.0.3"%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 7.0.3 release:
