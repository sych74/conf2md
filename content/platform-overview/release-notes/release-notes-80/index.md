...
aliases: "/release-notes-80/"
seoindex: "index, follow"
seotitle: "Release Notes 8.0"
seokeywords: "paas, paas release notes, paas version, 8.0 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the Virtuozzo PaaS 8.0 release."
menu:
    docs:
        title: "Release Notes 8.0"
        url: "/release-notes-80/"
        weight: 36
        parent: "release-notes"
        identifier: "release-notes-80.md"
---
...
{{%rn-changed%}}
{{%rn-item url="#autofs-downgrade"%}}
## AutoFS Downgrade
Set a fixed, stable *AutoFS 5.1.6* version instead of the latest one due to performance issues
{{%/rn-item%}}
...
Below, you can find the fixes that were implemented in the Virtuozzo Application Platform 8.0 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="Virtuozzo Application Platform 8.0"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-58066|3.3|Same error description in the emails for the *Let’s Encrypt SSL* installation, configuration, and certificate update actions
JE-60859|3.3|An error occurs when installing the *New Relic APM* add-on on the *LLSMP* stack
JE-63103|3.3|An error occurs when installing the *Docker Engine* and *Docker Swarm* packages with the *Portainer* option enabled
JE-63279|3.3|An error occurs after restarting an environment with the *Liferay* application from the platform Marketplace
JE-63726|3.3|The *java.orig* process works incorrectly in the *Liferay* application from the platform Marketplace
JE-63927|3.3|OOM error triggers during the installation of the *Liferay* application from the platform Marketplace
JE-63625|5.0.5|Incorrect *max open files* limit for some of the software stacks
JE-63873|5.8|Oversized *t_tracked_actions* data volume when installing the *Backup add-on for WordPress*
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from Virtuozzo Application Platform 8.0 release:

{{%table3 title="Virtuozzo Application Platform 8.0"%}}
**#**|**Affected Versions**|**Description**
---|:---:|---
JE-63799|7.3|An error occurs when editing the automatic horizontal scaling triggers
JE-64201|-|The post-install actions fail on the images based on the *Ubuntu 21.04* OS template
{{%/table3%}}
