...
aliases: "/release-notes-823/"
seoindex: "index, follow"
seotitle: "Release Notes 8.2.3"
seokeywords: "paas, paas release notes, paas version, 8.2.3 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the Virtuozzo PaaS 8.2.3 release."
menu:
    docs:
        title: "Release Notes 8.2.3"
        url: "/release-notes-823/"
        weight: 32
        parent: "release-notes"
        identifier: "release-notes-823.md"
---

<a id="back"></a>

# Virtuozzo Application Platform 8.2.3

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **Virtuozzo PaaS 8.2.3** release.
...
Below, you can find the fixes that were implemented in the Virtuozzo Application Platform 8.2.3 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="Virtuozzo Application Platform 8.2.3"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-65526|any|An error occurs when creating *Magento Cluster* from the platform Marketplace
JE-65859|3.3|Some *Let's Encrypt* processes are not removed after uninstalling the add-on
JE-65546|5.7.4|The "*SSL Service Unavailable*" error occurs when accessing the *LiteSpeed ADC* admin panel
{{%/table3%}}
