...
aliases: "/release-notes-824/"
seoindex: "index, follow"
seotitle: "Release Notes 8.2.4"
seokeywords: "paas, paas release notes, paas version, 8.2.4 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the Virtuozzo PaaS 8.2.4 release."
menu:
    docs:
        title: "Release Notes 8.2.4"
        url: "/release-notes-824/"
        weight: 31
        parent: "release-notes"
        identifier: "release-notes-824.md"
---
...
{{%rn-new%}}
{{%rn-item url="#almalinux-8-os-support"%}}
## AlmaLinux 8 OS Support
Added support for the *AlmaLinux 8* OS template
{{%/rn-item%}}
{{%/rn-new%}}
...
Starting with the current 8.2.4 PaaS release, the alternative OS template for the discontinued *CentOS Linux 8* stable release was changed to ***AlmaLinux 8***. [AlmaLinux](https://almalinux.org/) is an open-source 1:1 binary-compatible clone of RHEL that is guided and built by the community.

{{%note%}}**Note:** Virtuozzo Application Platform no longer supports the previously used *CentOS Stream 8* operating system template.{{%/note%}}
