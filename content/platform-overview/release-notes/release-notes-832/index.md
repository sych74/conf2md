...
aliases: "/release-notes-832/"
seoindex: "index, follow"
seotitle: "Release Notes 8.3.2"
seokeywords: "paas, paas release notes, paas version, 8.3.2 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the Virtuozzo PaaS 8.3.2 release."
menu:
    docs:
        title: "Release Notes 8.3.2"
        url: "/release-notes-832/"
        weight: 28
        parent: "release-notes"
        identifier: "release-notes-832.md"
---
...
{{%rn-changed%}}
{{%rn-item url="#ssh-gate-improvements"%}}
## SSH Gate Improvements
Provided a number of updates and improvements to enhance *SSH Gate* security, reliability, and usability
{{%/rn-item%}}
...
**[SSH Gate](/ssh-gate/)** component of the platform that helps connect to environments via SSH protocol. In the current 8.3.2 platform version, several improvements were applied to ensure the security and reliability of the process:
...
{{%table3 title="Virtuozzo Application Platform 8.3.2"%}}
