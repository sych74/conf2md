---
title: "Release Notes 5.7.6"
aliases: "/release-notes-576/"
seoindex: "index, follow"
seotitle: "Release Notes 5.7.6"
seokeywords: ""
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 5.7.6 release.Debian 10 OS..."
---

<a id="back"></a>

# Virtuozzo Application Platform 5.7.6

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 5.7.6** release.

{{%rn-new%}}
{{%rn-item url="#debian-10-os-distribution-support"%}}
...
In the present 5.7.6 PaaS release, the list of Linux distributions that are supported as a [base for Docker images](/docker-supported-distributions) was extended with the latest ***Debian 10*** operating system. Now, the platform can create any custom Docker container based on this OS type.
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 5.7.6 release:
