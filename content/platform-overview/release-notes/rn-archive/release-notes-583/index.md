---
draft: false
title: "Release Notes 5.8.3"
aliases: "/release-notes-583/"
seoindex: "index, follow"
seotitle: "Release Notes 5.8.3"
seokeywords: ""
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 5.8.3 release.Software Stack..."
---

<a id="back"></a>

# Virtuozzo Application Platform 5.8.3

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the <strong>PaaS 5.8.3</strong> release.
...
Below, you can find the fixes that were implemented in the PaaS 5.8.3 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 5.8.3"%}}
**#**|**Compatible from**|**Description**
---|---|---
JE-39417|3.3|The replication master in the *PostgreSQL Auto-Clustering* should be the same as the master node of the layer
JE-53070|3.3|For environments with multiple load balancers, the *Let's Encrypt* add-on is installed on the master node only
JE-52845|5.3|The *Docker Swarm Cluster* installation is stuck if the *portainer* and *Let's Encrypt* options are selected togethe<a id="software"></a>r
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 5.8.3 release:

{{%bug-fixes title="PaaS 5.8.3"%}}
**#**|**Description**
---|---
JE-52867|Some custom Docker images based on the *Ubuntu 18.04* OS template cannot be installed
JE-52879|An error occurs when redeploying *Debian VPS* from *10.2* to *10.3* version
JE-52919|The *autofs* package is disabled on containers with active mounts after redeployment
JE-53002|Incorrect behavior of the *Sum Adjustment* slider in the balance *Refill* and *Auto-Refill* forms
JE-53035|An error occurs when creating an environment with the *MongoDB* auto-cluster
{{%/bug-fixes%}}
{{%right%}}[Back to the top](#back){{%/right%}}