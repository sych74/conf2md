---
draft: false
title: "Release Notes 5.8.4"
aliases: "/release-notes-584/"
seoindex: "index, follow"
seotitle: "Release Notes 5.8.4"
seokeywords: ""
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 5.8.4 release.Software Stack..."
---

<a id="back"></a>

# Virtuozzo Application Platform 5.8.4

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the <strong>PaaS 5.8.4</strong> release.
...
Below, you can find the fixes that were implemented in the PaaS 5.8.4 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 5.8.4"%}}
**#**|**Compatible from**|**Description**
---|---|---
JE-53172|5.4|The *Auto-Clustering* switcher is absent in the topology wizard for some of the *MySQL* and *MariaDB* tag<a id="software"></a>s
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 5.8.4 release:

{{%bug-fixes title="PaaS 5.8.4"%}}
**#**|**Description**
---|---
JE-52927|An environment disappears from the dashboard UI after creation
JE-53252|If the JPS installation fails due to the "*Data too long*" error, any subsequent installation fails as well
JE-53272|Execution of the JPS packages that produce a prolonged response fails with the "*Data too long*" error
JE-53280|An error occurs when trying to redeploy containers
{{%/bug-fixes%}}
{{%right%}}[Back to the top](#back){{%/right%}}