---
draft: false
title: "Release Notes 5.9.6"
aliases: "/release-notes-596/"
seoindex: "index, follow"
seotitle: "Release Notes 5.9.6"
seokeywords: "paas, paas release notes, paas version, 5.9.6 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 5.9.6 release."
---

<a id="back"></a>

# Virtuozzo Application Platform 5.9.6

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 5.9.6** release.
...
Below, you can find the fixes that were implemented in the PaaS 5.9.6 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 5.9.6"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-55527|5.7|Slave nodes should be distributed equally between masters of the MySQL auto-cluster (the *Master-Master* scheme)
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 5.9.6 release:

{{%table3 title="PaaS 5.9.6"%}}
**#**|**Affected Versions**|**Description**
---|:---:|---
JE-55808|5.9.5|An error occurs when redeploying a container with an image from the *private* registry
{{%/table3%}}
