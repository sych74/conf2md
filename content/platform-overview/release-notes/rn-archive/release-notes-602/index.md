...
aliases: "/release-notes-602/"
seoindex: "index, follow"
seotitle: "Release Notes 6.0.2"
seokeywords: "paas, paas release notes, paas version, 6.0.2 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 6.0.2 release."
---

<a id="back"></a>

# Virtuozzo Application Platform 6.0.2

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 6.0.2** release.
...
Below, you can find the fixes that were implemented in the PaaS 6.0.2 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 6.0.2"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-56734|3.3|Incorrect value for the *mbstring.encoding_translation* parameter for the *Drupal* application after installation from the Marketplace
JE-56670|5.0.5|*Apache PHP* application server fails after redeployment to a different major PHP version
JE-54752|5.0.5|The *variablesparser.sh* script should be installed during the *Java Memory Agent* add-on installation
JE-50132|5.7|Cannot *bind-address 0.0.0.0* on the *Galera MySQL/MariaDB Cluster* package
JE-56221|5.7|The *setupWP.sh* configuration file should be kept during the *WordPress Cluster* redeploy
JE-57563|5.7.4|The content of the */var/lib/glusterd/* folder should be preserved during the *GlusterFS* Cluster configuration
JE-57125|5.8.1|The *Open Liberty* application does not work after installation from the Marketplace
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 6.0.2 release:

{{%table3 title="PaaS 6.0.2"%}}
**#**|**Affected Versions**|**Description**
---|:---:|---
JE-57584|-|An error occurs when creating an environment with public *IPv6*
JE-57482|6.0|The "*Destination NFS server is not reachable*" error occurs when creating a mount point to a *non-Storage* node
{{%/table3%}}
