---
draft: false
title: "Release Notes 6.0.4"
aliases: "/release-notes-604/"
seoindex: "index, follow"
seotitle: "Release Notes 6.0.4"
seokeywords: "paas, paas release notes, paas version, 6.0.4 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 6.0.4 release."
---

<a id="back"></a>

# Virtuozzo Application Platform 6.0.4

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 6.0.4** release.
...
Below, you can find the fixes that were implemented in the PaaS 6.0.4 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 6.0.4"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-57936|3.3|The "*Eclipse Vert.x Fat Jar Builder*" application in Marketplace does not work on the platforms below the *6.0.3* version
JE-56783|5.0.5|HTTP2 doesn't work through the *Shared Load Balancer* for some templates
JE-58086|5.0.5|The *fuzzyrpm* repository should be skipped if it is unavailable during the Let's Encrypt add-on installation
JE-58054|5.3|The home directory on the certified *DockerCE* template should be added to the *Favorites* shortcuts in the dashboard
JE-48968|5.4|An error occurs on the *GlassFish* node after redeployment
JE-58256|5.4|*SQL-service* is inactive after stopping and starting an environment with the *Galera* cluster
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 6.0.4 release:

{{%table3 title="PaaS 6.0.4"%}}
**#**|**Affected Versions**|**Description**
---|:---:|---
JE-46792|-|JPS installation fails due to the onInstall and container aftercreate operations conflict
JE-57838|-|Kubernetes Cluster installation fails due to the Java exception error
JE-57966|-|Firewall state cannot be changed (enabled/disabled) on the Ubuntu-based VPS nodes
JE-58045|6.0|Firewall rules should be backed up and tested before the appliance
JE-58052|-|Region icons are not displayed during the JPS package installation
JE-58055|-|An error occurs when installing applications from the Marketplace
JE-58071|-|Incorrect CSS for the list field tooltips in some packages at the Marketplace
JE-58093|-|Links in the list field tooltips of the topology wizard are not clickable
JE-58094|-|The list field tooltip is broken when used with the \<a> HTML tag
JE-58259|6.0|Container redeployment fails if a symlink is added to the persistent files
JE-58262|5.3|Incorrect IP address sequence for containers with public IP after environment migration to the different region
{{%/table3%}}
