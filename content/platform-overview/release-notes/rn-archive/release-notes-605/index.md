...
aliases: "/release-notes-605/"
seoindex: "index, follow"
seotitle: "Release Notes 6.0.5"
seokeywords: "paas, paas release notes, paas version, 6.0.5 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 6.0.5 release."
---
...
{{%rn-changed%}}
{{%rn-item url="#beta-label-removal-for-mongodbpostgresql-auto-clustering"%}}
## Beta Label Removal for MongoDB/PostgreSQL Auto-Clustering
Removed the *beta* label for the MongoDB and PostgreSQL auto-clustering
{{%/rn-item%}}
...
{{%table3 title="PaaS 6.0.5"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-56979|3.3|*Cyclos 4.14* and higher should be installed based on the *Java 11* engine due to the updated requirements of the application
JE-57555|3.3|An error occurs when trying to update the *New Relic* add-on on the PHP environment
JE-58449|3.3|An error occurs when installing *GitBlit* from the Marketplace
JE-49402|5.0.5|The "504 application down" error occurs after deployment for some *Apache Ruby* server versions
JE-57945|5.3.2|The *WildFly* service is not added to the *chkconfig* config
JE-52035|5.7|The *Node-RED Dev* installation from Marketplace should be restricted on accounts without endpoints permissions
JE-58275|5.7|The *Rocket.Chat* installation must be restricted for accounts with less than three nodes allowed per layer
{{%/table3%}}
...
JE-58259|6.0|An error occurs when redeploying *Ubuntu-based* images
JE-58309|6.0|OOM killer alerts should be enabled on containers by default
...
JE-58537|any|The *High-Availability* and *Auto-Clustering* features can be enabled simultaneously for Tomcat/TomEE
{{%/table3%}}
