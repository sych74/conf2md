...
aliases: "/release-notes-613/"
seoindex: "index, follow"
seotitle: "Release Notes 6.1.3"
seokeywords: "paas, paas release notes, paas version, 6.1.3 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 6.1.3 release."
---
...
{{%rn-new%}}
{{%rn-item url="#debian-11-os-template-support"%}}
...
{{%rn-changed%}}
{{%rn-item url="#pop-up-notifications-for-interrupted-onbeforeinit-event"%}}
...
Also, *Debian 11* was added as an out-of-box [Elastic VPS](/debian-vps/) stack in the platform dashboard.

![Debian 11 elastic VPS](01-debian-11-elastic-vps.png)
...
![dashoard notification types](02-dashoard-notification-types.png)
...
{{%table3 title="PaaS 6.1.3"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-59249|3.3|One of the Tomcat instances of the *Cyclos 4 PRO Cluster* package returns a 404 error
JE-59709|3.3|The *Cyclos 4 PRO Cluster* package returns a 404 error after enabling *built-in SSL* for the environment
JE-59618|5.0.5|An error occurs after the *Couchbase Cluster* creation from the Marketplace
{{%/table3%}}
