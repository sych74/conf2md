...
aliases: "/release-notes-62/"
seoindex: "index, follow"
seotitle: "Release Notes 6.2"
seokeywords: "paas, paas release notes, paas version, 6.2 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 6.2 release."
---

<a id="back"></a>

# Virtuozzo Application Platform 6.2

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 6.2** release.

{{%rn-changed%}}
{{%rn-item url="#debian-11-os-template-update"%}}
## Debian 11 OS Template Update
Updated the base OS template for *Debian 11* software stacks
{{%/rn-item%}}
...
The OS template for the [recently implemented **Debian 11** stack](/release-notes-613/#debian-11-os-template-support) was updated in the current 6.2 PaaS release. The new OS template version provides even greater stability for the containers based on this image.
...
Below, you can find the fixes that were implemented in the PaaS 6.2 release and also integrated into previous platform versions by means of the appropriate patches.

{{%table3 title="PaaS 6.2"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-29125|any|The PaaS account can be refilled twice via a single WHMCS order
JE-60157|3.3|An error occurs when installing the *Liferay* package from the platform Marketplace
JE-60195|3.3|The *Nexus Repository Manager* package from the platform Marketplace is not working after the installation
JE-59899|5.0.5|An error occurs when connecting to the *Ruby-based* container via SSH
JE-55656|5.4|The *Jira Software* installation from the platform Marketplace should be restricted for accounts without public IP permissions
JE-56521|5.4|Custom data and settings are missing on the *Docker Engine CE* package after redeploy
JE-60364|5.4|An error occurs when accessing the *Portainer* admin panel of the *Docker Swarm* package
JE-53679|5.7|The *OpenFaaS* installation from the platform Marketplace should be restricted for accounts with insufficient limits
JE-60198|5.7|An error occurs when installing the *Magento CE 1.9.4.x* cluster from the platform Marketplace
{{%/table3%}}
...
---|:---:|---
JE-60308|-|The "*Contact Support*" SSO link from the platform dashboard to the WHMCS portal is not working
JE-60361|6.0.4|Incorrect primary IP after migration if anode has both *IPv4* and *IPv6* public addresses
JE-60362|5.3|Migration fails if an environment has nodes with and without *IPv6* addresses
JE-60369|-|The reconfiguration add-on for the *Traffic Distributor* solution is not working
{{%/table3%}}
