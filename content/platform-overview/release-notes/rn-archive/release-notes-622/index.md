...
aliases: "/release-notes-622/"
seoindex: "index, follow"
seotitle: "Release Notes 6.2.2"
seokeywords: "paas, paas release notes, paas version, 6.2.2 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the platform 6.2.2 release."
---

<a id="back"></a>

# Virtuozzo Application Platform 6.2.2

*This document is preliminary and subject to change.*

In this document, you will find all of the new features, enhancements and visible changes included to the **PaaS 6.2.2** release.
...
{{%table3 title="PaaS 6.2.2"%}}
**#**|**Compatible from**|**Description**
---|:---:|---
JE-59734|3.3|A lot of resources are blocked (mixed content) when operating *Cyclos 4 Cluster* with SSL enabled
JE-59858|3.3|Incorrect permissions after the *Fail2Ban* add-on installation
JE-60154|3.3|An error occurs when installing the *Odoo CE 9* or *10* packages from the platform Marketplace
JE-54042|5.0.5|Errors present in log files after the *WildFly Cluster* installation
JE-60399|5.4|Application ID is missing for the *Magento* package in the platform Marketplace
JE-59830|5.7.4|Memory auto-configuration is not applied for the *LLSMP* stack when decreasing the cloudlets count
JE-59882|5.7.4|The *WAF* environment variable does not adjust the Web Application Firewall setting on the *LiteSpeed* server.
{{%/table3%}}
...
In the table below, you can see the list of bug fixes applied to the platform starting from PaaS 6.2.2 release:

{{%table3 title="PaaS 6.2.2"%}}
**#**|**Affected Versions**|**Description**
---|:---:|---
JE-60442|any|The *onBefore-* and *onAfterAddNode* CS events do not work with nodes in extra layers
{{%/table3%}}
