...
aliases: "/wordpress-release-notes-21/"
seoindex: "index, follow"
seotitle: "WordPress PaaS 2.1"
seokeywords: "wordpress hosting, wordpress package, wordpress cluster, wordpress paas, wordpress release notes, wordpress paas version, wordpress 2.1 release"
seodesc: "In this document, you will find all of the new features, enhancements and visible changes included to the Virtuozzo Application Platform for WordPress 2.1 release."
menu:
    docs:
        title: "WordPress PaaS 2.1"
        url: "/wordpress-release-notes-21/"
        weight: 48
        parent: "wordpress-release-notes"
        identifier: "wordpress-release-notes-21.md"
---
...
![managing account subscriptions](01-managing-account-subscriptions.png)
...
![changing project subscription plan](02-changing-project-subscription-plan.png)
...
![project endpoints](03-project-endpoints.png)
...
![user information](04-user-information.png)
...
![WodPress admin panel link](05-wodpress-admin-panel-link.png)
...
![changing dashboard language](06-changing-dashboard-language.png)
